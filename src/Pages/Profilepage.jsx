  ...
  return (
    <>
      {/* main page  */}
        ...
        <div className=" w-full flex flex-col  cmn-bg   gap-4 p-2 sm:p-1  ">
          {/* Profile Section */}
            ...
            <div className="flex  flex-col  items-center ">
              <div className="flex  gap-2  p-2">
                ...
                <div className=" space-y-1">
                  ...
                  <p className="text-sm ubuntu-light cmn-text leading-relaxed ">
                    {userdata?.desc}
                  </p>
                </div>
              </div>
            ...
            <div className="text-gray-600    flex items-center justify-between py-2 ">
              <ul className=" ubuntu-regular flex  items-center gap-3  ">
                ...
                <li className="flex items-center justify-center ">
                  <Link
                    to={"/addblog"}
                    className="hover:bg-[#5941C6] rounded-full"
                  >
                    <Button className="bg-blue-500 rounded-full hover:bg-blue-600">
                      Add Blog
                    </Button>
